...
class Product(models.Model):
    ...
    purpose = models.CharField('paskirtis', max_length=50, null=True, blank=True)
...
class Report(models.Model):
    ...
    remakes = models.ForeignKey(Remake, help_text='Pasirinkite perdarimo priežastis', on_delete=models.CASCADE, null=True, blank=True)
